...
def inject_lab_script(html: str) -> str:
    ...
    admin_btn = """<a href='/admin' title='Admin Panel' aria-label='Admin Panel' style='position: fixed; top: 20px; right: 80px; width: 45px; height: 45px; border-radius: 50%; border: 1px solid rgba(255, 255, 255, 0.2); background: rgba(10, 10, 10, 0.85); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); box-shadow: 0 10px 30px rgba(0, 0, 0, 0.3), inset 0 0 15px rgba(255, 255, 255, 0.1); color: white; display: flex; align-items: center; justify-content: center; z-index: 999999; text-decoration: none; transition: all 0.5s cubic-bezier(0.16, 1, 0.3, 1);' onmouseover="this.style.transform='scale(1.05) translateY(-3px)';this.style.boxShadow='0 15px 40px rgba(0,0,0,0.4), 0 0 20px rgba(139,92,246,0.4), inset 0 0 15px rgba(255,255,255,0.2)';this.style.borderColor='rgba(255,255,255,0.4)'" onmouseout="this.style.transform='';this.style.boxShadow='0 10px 30px rgba(0,0,0,0.3), inset 0 0 15px rgba(255,255,255,0.1)';this.style.borderColor='rgba(255,255,255,0.2)'"><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z'/><circle cx='12' cy='12' r='3'/></svg></a>"""
